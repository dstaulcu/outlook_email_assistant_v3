if (window.Type && window.Type.registerNamespace) {
    ...
    if (typeof (window['"Strings"']) == 'undefined') {
        ...
        window['"Strings"'].__namespace = true;
    }

}
Strings.OfficeOM = function() {}
;
if (Strings.OfficeOM.registerClass)
...
Strings.OfficeOM.L_UndoNotSupportedMessage = "The JavaScript API request failed due to the lack of support for the undo operation.";
