...
, , function(e, t, n) {
    ...
    t.isBeaconsSupported = function() {
        return null === s && (s = "undefined" != typeof navigator && Boolean(navigator.sendBeacon)),
        s
    }
    ,
    t.isUint8ArrayAvailable = function() {
        return null === a && (a = "undefined" != typeof Uint8Array && !function() {
    ...
    t.sanitizeProperty = function(e, n) {
        return !t.PropertyNameRegex.test(e) || y(n) ? null : (y(n.value) && (n = {
            value: n,
            type: r.AWTPropertyType.Unspecified
        }),
        n.type = function(e, t) {
            switch (t = function(e) {
                if (l(e) && e >= 0 && e <= 4)
                    return !0;
                return !1
            }(t) ? t : r.AWTPropertyType.Unspecified) {
            case r.AWTPropertyType.Unspecified:
                return function(e) {
                    ...
                    case "object":
                        return p(e) ? r.AWTPropertyType.Date : null
                    }
                    return null
                }(e);
            ...
            case r.AWTPropertyType.Date:
                return p(e) && NaN !== e.getTime() ? t : null;
        ...
        n.type ? (p(n.value) && (n.value = f(n.value.getTime())),
        n.pii > 0 && n.cc > 0 ? null : n.pii ? function(e) {
            if (l(e) && e >= 0 && e <= 13)
                return !0;
            return !1
        }(n.pii) ? n : null : n.cc ? function(e) {
            if (l(e) && e >= 0 && e <= 1)
                return !0;
            return !1
        }(n.cc) ? n : null : n) : null)
    ...
    t.getISOString = function(e) {
        return e.getUTCFullYear() + "-" + v(e.getUTCMonth() + 1) + "-" + v(e.getUTCDate()) + "T" + v(e.getUTCHours()) + ":" + v(e.getUTCMinutes()) + ":" + v(e.getUTCSeconds()) + "." + function(e) {
            if (e < 10)
                return "00" + e;
            if (e < 100)
                return "0" + e;
    ...
    ,
    t.isReactNative = _,
    t.isServiceWorkerGlobalScope = h
}
, function(e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
    ...
    var i = n(12)
      ...
      , l = function() {
        ...
        e.scheduleTimer = function() {
            ...
            this._timeout < 0 && t >= 0 && !this._paused && (this._eventHandler.hasEvents() ? (0 === t && this._currentBackoffCount > 0 && (t = 1),
        ...
        e.initialize = function(e) {
            ...
            this._config = e,
            this._eventHandler = new o.default(e.collectorUri,e.cacheMemorySizeLimitInNumberOfEvents,e.httpXHROverride,e.clockSkewRefreshDurationInMins),
            this._initializeProfiles(),
            s.default.initialize((function(e, n) {
                if (t._config.canSendStatEvent("awt_stats")) {
                    var i = new a.default("awt_stats");
                    for (var o in i.setEventPriority(r.AWTEventPriority.High),
        ...
        e.sendEvent = function(e) {
            this._newEventsAllowed && (this._currentBackoffCount > 0 && e.priority === r.AWTEventPriority.Immediate_sync && (e.priority = r.AWTEventPriority.High),
        ...
        e.flush = function(e) {
            ...
            this._timeout > -1 && (clearTimeout(this._timeout),
            this._timeout = -1),
        ...
        e.clearBackOff = function() {
            this._currentBackoffCount > 0 && (this._currentBackoffCount = 0,
            this.clearTimeout(),
            this.scheduleTimer())
        }
        ,
        ...
        e.clearTimeout = function() {
            this._timeout > 0 && (clearTimeout(this._timeout),
            this._timeout = -1,
            this._timerCount = 0)
        }
        ,
...
, function(e, t, n) {
    ...
    var i = function() {
        ...
        e.eventsSent = function(e) {
            ...
            }, i = this, r = 0; r < this.listeners.length; ++r)
                n(r)
        }
        ,
        e.eventsDropped = function(e, t) {
            for (var n = this, i = function(i) {
                r.listeners[i].eventsDropped && setTimeout((function() {
                    return n.listeners[i].eventsDropped(e, t)
                }
                ), 0)
            }, r = this, o = 0; o < this.listeners.length; ++o)
                i(o)
        }
        ,
        ...
        e.eventsRejected = function(e, t) {
            for (var n = this, i = function(i) {
                r.listeners[i].eventsRejected && setTimeout((function() {
    ...
    var i = n(3)
      ...
      , o = function() {
        ...
        e.prototype.setPropertyWithPii = function(e, t, n, o) {
            ...
            null !== (s = i.sanitizeProperty(e, s)) ? this._event.properties[e] = s : delete this._event.properties[e]
        }
        ,
...
, function(e, t, n) {
    ...
    var i = n(3)
      ...
      , E = /(windows|win32)/i
      , P = / arm;/i
      , I = /windows\sphone\s\d+\.\d+/i
      , W = /(macintosh|mac os x)/i
      , b = /(iPad|iPhone|iPod)(?=.*like Mac OS X)/i
      ...
      , k = function() {
        ...
        e.autoCollect = function(e, t, n) {
            ...
            this._disableCookies && !this._propertyStorage)
                return this._deleteCookie(r),
                void this._deleteCookie(o);
        ...
        e.checkAndSaveDeviceId = function(e) {
            if (e) {
                var t = this._getData(r)
                  , n = this._getData(o);
                t !== e && (n = i.getISOString(new Date)),
                this._saveData(r, e),
                this._saveData(o, n),
        ...
        e._getBrowserName = function(e) {
            return this._userAgentContainsString("OPR/", e) ? _ : this._userAgentContainsString(f, e) ? f : this._userAgentContainsString(l, e) || this._userAgentContainsString("Edg", e) ? l : this._userAgentContainsString(d, e) ? d : this._userAgentContainsString(a, e) ? a : this._userAgentContainsString("Trident", e) ? s : this._userAgentContainsString(u, e) ? u : this._userAgentContainsString(c, e) ? c : this._userAgentContainsString(p, e) ? p : "Unknown"
        }
        ,
        ...
        e._getBrowserVersion = function(e, t) {
            if (t === s)
                return this._getIeVersion(e);
            if (t === l) {
                var n = this._getOtherVersion(t, e);
                return "Unknown" === n ? this._getOtherVersion("Edg", e) : n
            }
        ...
        e._getOsName = function(e) {
            return e.match(I) ? y : e.match(P) ? g : e.match(b) ? T : e.match(C) ? m : e.match(w) ? S : e.match(W) ? v : e.match(E) ? h : e.match(B) ? A : "Unknown"
        }
        ,
        e._getOsVersion = function(e, t) {
            return t === h ? this._getGenericOsVersion(e, "Windows NT") : t === m ? this._getGenericOsVersion(e, t) : t === v ? this._getMacOsxVersion(e) : "Unknown"
        }
        ,
        e._getGenericOsVersion = function(e, t) {
            var n = e.match(new RegExp(t + " ([\\d,.]+)"));
            return n ? O[n[1]] ? O[n[1]] : n[1] : "Unknown"
        }
        ,
        e._getMacOsxVersion = function(e) {
            var t = e.match(new RegExp(v + " ([\\d,_,.]+)"));
            if (t) {
        ...
        e._getData = function(e) {
            ...
            if (this._areCookiesAvailable) {
                ...
                for (var t = document.cookie.split(";"), n = 0; n < t.length; n++) {
                    for (var i = t[n], r = 0; " " === i.charAt(r); )
                        r++;
                    if (0 === (i = i.substring(r)).indexOf(e))
    ...
    var i = n(0)
      ...
      , c = function() {
        function e(e, t, n, o) {
            ...
            this._httpManager = new r.default(this._outboundQueue,e,this,n,o)
        }
        return e.prototype.addEvent = function(e) {
            u.isPriority(e.priority) || (e.priority = i.AWTEventPriority.Normal),
            e.priority === i.AWTEventPriority.Immediate_sync ? this._httpManager.sendSynchronousRequest(this._batcher.addEventToBatch(e), e.apiKey) : this._queueSize < this._queueSizeLimit || this._dropEventWithPriorityOrLess(e.priority) ? this._addEventToProperQueue(e) : a.default.eventsDropped([e], i.AWTEventsDroppedReason.QueueFull)
        }
        ,
                ...
                for (var t in e)
                    if (e.hasOwnProperty(t))
                        for (var n = 0; n < e[t].length; ++n)
                            e[t][n].sendAttempt < 6 ? this.addEvent(e[t][n]) : a.default.eventsDropped([e[t][n]], i.AWTEventsDroppedReason.MaxRetryLimit);
                o.default.scheduleTimer()
            }
        }
        ,
        e.prototype.teardown = function() {
            this._paused || (this._batchEvents(i.AWTEventPriority.Low),
        ...
        e.prototype.pauseTransmission = function() {
            ...
            this._shouldDropEventsOnPause && (this._queueSize -= this._inboundQueues[i.AWTEventPriority.High][0].length + this._inboundQueues[i.AWTEventPriority.Normal][0].length + this._inboundQueues[i.AWTEventPriority.Low][0].length,
        ...
        e.prototype._dropEventWithPriorityOrLess = function(e) {
            for (var t = i.AWTEventPriority.Low; t <= e; ) {
                if (this._inboundQueues[t][this._inboundQueues[t].length - 1].length > 0)
                    return a.default.eventsDropped([this._inboundQueues[t][this._inboundQueues[t].length - 1].shift()], i.AWTEventsDroppedReason.QueueFull),
                    !0;
                t++
            }
            return !1
        ...
        e.prototype._uploadNow = function(e) {
            ...
            this._checkOutboundQueueEmptyAndSent((function() {
                ...
                null != e && e(),
                t._uploadNowQueue.length > 0 ? setTimeout((function() {
                    return t._uploadNow(t._uploadNowQueue.shift())
                }
                ), 0) : (t._isCurrentlyUploadingNow = !1,
                t.hasEvents() && o.default.scheduleTimer())
            }
            ))
        }
        ,
    ...
    var i = n(0)
      ...
      , _ = function() {
        function e(e) {
            ...
            this._semanticContext = new p.default(!1,this._contextProperties),
        ...
        e.prototype.setContextWithPii = function(e, t, n, r) {
            ...
            this._contextProperties.setPropertyWithPii(e, t, n, r)
        }
        ,
        e.prototype.setContextWithCustomerContent = function(e, t, n, r) {
            void 0 === r && (r = i.AWTPropertyType.Unspecified),
            this._contextProperties.setPropertyWithCustomerContent(e, t, n, r)
        }
        ,
        ...
        e.prototype.logEvent = function(t) {
            if (l.default.loggingEnabled) {
                this._apiKey || (this._apiKey = l.default.defaultTenantToken,
                this._createInitId());
                var n = !0;
                s.isString(t) ? t = {
                    name: t
                ...
                n = !1),
                a.default.eventReceived(this._apiKey),
            ...
            if (l.default.sessionEnabled) {
                ...
                t === r.AWTSessionState.Started) {
                    ...
                    if (0 === this._sessionStartTime)
                        return;
                    var a = Math.floor(((new Date).getTime() - this._sessionStartTime) / 1e3);
                    o.properties["Session.Id"] = this._sessionId,
                    o.properties["Session.State"] = "Ended",
                    o.properties["Session.Duration"] = a.toString(),
                    o.properties["Session.DurationBucket"] = e._getSessionDurationFromTime(a),
                    this._sessionStartTime = 0,
                    this.setContext("Session.Id", null),
                    this._sessionId = void 0
                }
                o.properties["Session.FirstLaunchTime"] = f.default.firstLaunchTime,
                this.logEvent(o)
            }
        }
        ,
        ...
        ,
        e.prototype.logFailure = function(t, n, r, o, s) {
            if (t && n) {
                var a = {
                    name: "failure",
                    type: "failure",
                ...
                e._addPropertiesToEvent(a, s),
                a.properties["Failure.Signature"] = t,
                a.properties["Failure.Detail"] = n,
                r && (a.properties["Failure.Category"] = r),
                o && (a.properties["Failure.Id"] = o),
                a.priority = i.AWTEventPriority.High,
                this.logEvent(a)
            }
        }
        ,
        e.prototype.logPageView = function(t, n, i, r, o, s) {
            if (t && n) {
                var a = {
                    name: "pageview",
                    type: "pageview",
                ...
                a.properties["PageView.Name"] = n,
                i && (a.properties["PageView.Category"] = i),
        ...
        e.prototype._createInitId = function() {
            !e._initIdMap[this._apiKey] && this._apiKey && (e._initIdMap[this._apiKey] = s.newGuid())
        }
        ,
        ...
        e._logEvent = function(e, t) {
            e.name && s.isString(e.name) ? (e.name = e.name.toLowerCase(),
            ...
            s.isPriority(e.priority) || (e.priority = i.AWTEventPriority.Normal),
            this._sendEvent(e)) : u.default.eventsRejected([e], i.AWTEventsRejectedReason.InvalidEvent)) : u.default.eventsRejected([e], i.AWTEventsRejectedReason.InvalidEvent)
        }
        ,
        ...
        e._getInternalEvent = function(e, t, n) {
            ...
            n)
                for (var i in e.properties)
                    e.properties.hasOwnProperty(i) && (e.properties[i] = s.sanitizeProperty(i, e.properties[i]),
            ...
            r.default.addNotificationListener({
                ...
                eventsDropped: function(e, n) {
                    ...
                    case o.AWTEventsDroppedReason.NonRetryableStatus:
                        ...
                        break;
                    case o.AWTEventsDroppedReason.MaxRetryLimit:
    ...
    var i = n(20)
      ...
      , a = function() {
        ...
        return e.getPayloadBlob = function(e, t) {
            var n, a = !1, u = new i.IO.MemoryStream, c = new i.CompactBinaryProtocolWriter(u);
            for (var l in c._WriteFieldBegin(i._BondDataType._BT_MAP, 3, null),
            c._WriteMapContainerBegin(t, i._BondDataType._BT_STRING, i._BondDataType._BT_LIST),
            e)
                if (a)
                    n || (n = {}),
                    n[l] = e[l],
                    ...
                    c._WriteString(l);
                    var d = e[l];
                    c._WriteContainerBegin(1, i._BondDataType._BT_STRUCT),
                    c._WriteFieldBegin(i._BondDataType._BT_STRING, 2, null),
                    c._WriteString("act_default_source"),
                    c._WriteFieldBegin(i._BondDataType._BT_STRING, 5, null),
                    c._WriteString(s.newGuid()),
                    c._WriteFieldBegin(i._BondDataType._BT_INT64, 6, null),
                    c._WriteInt64(s.numberToBondInt64(Date.now())),
                    c._WriteFieldBegin(i._BondDataType._BT_LIST, 8, null);
                    var p = u._GetBuffer().length + 1;
                    c._WriteContainerBegin(e[l].length, i._BondDataType._BT_STRUCT);
                    for (var f = u._GetBuffer().length - p, _ = 0; _ < d.length; ++_) {
                        var h = u._GetBuffer().length;
                        if (this.writeEvent(d[_], c),
                        u._GetBuffer().length - h > 2936012)
                            o.default.eventsRejected([d[_]], r.AWTEventsRejectedReason.SizeLimitExceeded),
                            d.splice(_--, 1),
                            u._GetBuffer().splice(h),
                            this._addNewDataPackageSize(d.length, u, f, p);
                        else if (u._GetBuffer().length > 2936012) {
                            u._GetBuffer().splice(h),
                            n || (n = {}),
                            e[l] = d.splice(0, _),
                            n[l] = d,
                            this._addNewDataPackageSize(e[l].length, u, f, p),
                            a = !0;
                            break
                        }
                    }
            ...
            {
                payloadBlob: u._GetBuffer(),
                remainingRequest: n
            }
        }
        ,
        e._addNewDataPackageSize = function(e, t, n, r) {
            for (var o = i._Encoding._Varint_GetBytes(i.Number._ToUInt32(e)), s = 0; s < n; ++s) {
                if (!(s < o.length)) {
                    t._GetBuffer().slice(r + s, n - s);
                    break
                }
                t._GetBuffer()[r + s] = o[s]
            }
        }
        ,
        e.writeEvent = function(e, t) {
            t._WriteFieldBegin(i._BondDataType._BT_STRING, 1, null),
            t._WriteString(e.id),
            t._WriteFieldBegin(i._BondDataType._BT_INT64, 3, null),
            t._WriteInt64(s.numberToBondInt64(e.timestamp)),
            t._WriteFieldBegin(i._BondDataType._BT_STRING, 5, null),
            t._WriteString(e.type),
            t._WriteFieldBegin(i._BondDataType._BT_STRING, 6, null),
            ...
            if (o)
                for (var T in t._WriteFieldBegin(i._BondDataType._BT_MAP, 13, null),
                t._WriteMapContainerBegin(o, i._BondDataType._BT_STRING, i._BondDataType._BT_STRING),
                n)
                    if (n.hasOwnProperty(T)) {
                        var m = n[T];
                        t._WriteString(T),
                        t._WriteString(m.toString())
                    }
            if (v)
                for (var T in t._WriteFieldBegin(i._BondDataType._BT_MAP, 30, null),
                t._WriteMapContainerBegin(v, i._BondDataType._BT_STRING, i._BondDataType._BT_STRUCT),
                h)
                    if (h.hasOwnProperty(T)) {
                        var S = h[T];
                        t._WriteString(T),
                        t._WriteFieldBegin(i._BondDataType._BT_INT32, 1, null),
                        t._WriteInt32(1),
                        t._WriteFieldBegin(i._BondDataType._BT_INT32, 2, null),
                        t._WriteInt32(S.pii),
                        t._WriteFieldBegin(i._BondDataType._BT_STRING, 3, null),
                        t._WriteString(S.value.toString()),
                        t._WriteStructEnd(!1)
                    }
            if (p)
                for (var T in t._WriteFieldBegin(i._BondDataType._BT_MAP, 31, null),
                t._WriteMapContainerBegin(p, i._BondDataType._BT_STRING, i._BondDataType._BT_BOOL),
                d)
            ...
            if (_)
                for (var T in t._WriteFieldBegin(i._BondDataType._BT_MAP, 32, null),
                t._WriteMapContainerBegin(_, i._BondDataType._BT_STRING, i._BondDataType._BT_INT64),
                f)
                    if (f.hasOwnProperty(T)) {
                        m = f[T];
                        t._WriteString(T),
                        t._WriteInt64(s.numberToBondInt64(m))
                    }
            if (u)
                for (var T in t._WriteFieldBegin(i._BondDataType._BT_MAP, 33, null),
                t._WriteMapContainerBegin(u, i._BondDataType._BT_STRING, i._BondDataType._BT_INT64),
                a)
            ...
            if (l)
                for (var T in t._WriteFieldBegin(i._BondDataType._BT_MAP, 34, null),
                t._WriteMapContainerBegin(l, i._BondDataType._BT_STRING, i._BondDataType._BT_DOUBLE),
                c)
            ...
            if (g)
                for (var T in t._WriteFieldBegin(i._BondDataType._BT_MAP, 36, null),
                t._WriteMapContainerBegin(g, i._BondDataType._BT_STRING, i._BondDataType._BT_STRUCT),
                y)
                    if (y.hasOwnProperty(T)) {
                        ...
                        t._WriteFieldBegin(i._BondDataType._BT_INT32, 1, null),
                        t._WriteInt32(S.cc),
                        t._WriteFieldBegin(i._BondDataType._BT_STRING, 2, null),
                        t._WriteString(S.value.toString()),
                        t._WriteStructEnd(!1)
                    }
            t._WriteStructEnd(!1)
      ...
      , l = function() {
        ...
        return e.initialize = function(e, t) {
            ...
            !this._isInitialized)
                ...
                this._config.disableCookiesUsage && !this._config.propertyStorageOverride && (o.default.sessionEnabled = !1),
                c.default.addPropertyStorageOverride(this._config.propertyStorageOverride),
                c.default.autoCollect(o.default.semanticContext, this._config.disableCookiesUsage, this._config.userAgent),
        ...
        e._overrideValuesFromConfig = function(e) {
            ...
            e.cacheMemorySizeLimitInNumberOfEvents > 0 && (this._config.cacheMemorySizeLimitInNumberOfEvents = e.cacheMemorySizeLimitInNumberOfEvents),
    ...
    var i = n(0)
      ...
      , p = function() {
        function e(e, t, n, i, r) {
            ...
            this._urlString = "?qsp=true&content-type=application%2Fbond-compact-binary&client-id=NO_AUTH&sdk-version=" + u.FullVersionString,
            this._killSwitch = new s.default,
            this._paused = !1,
            this._useBeacons = !1,
            this._activeConnections = 0,
            this._clockSkewManager = new a.default(r),
            c.isUint8ArrayAvailable() || (this._urlString += "&content-encoding=base64"),
            this._urlString = t + this._urlString,
            this._httpInterface || (this._useBeacons = !c.isReactNative(),
            this._httpInterface = {
                sendPOST: function(e, t, n, i, r, s) {
                    try {
                        if (c.useFetchRequest())
                            fetch(e, {
                                body: t,
                                method: "POST"
                            }).then((function(e) {
                            ...
                            u.open("POST", e, !s),
                            u.onload = function() {
                                r(u.status, o._convertAllHeadersToMap(u.getAllResponseHeaders()))
                            }
                            ,
                            u.onerror = function() {
                                i(u.status, o._convertAllHeadersToMap(u.getAllResponseHeaders()))
                            }
                            ,
                            u.ontimeout = function() {
                                n(u.status, o._convertAllHeadersToMap(u.getAllResponseHeaders()))
                            }
                            ,
                            u.send(t)
                        }
        ...
        e.prototype.sendQueuedRequests = function() {
            for (; this.hasIdleConnection() && !this._paused && this._requestQueue.length > 0 && this._clockSkewManager.allowRequestSending(); )
        ...
        e.prototype.sendSynchronousRequest = function(e, t) {
            this._paused && (e[t][0].priority = i.AWTEventPriority.High),
            this._activeConnections++,
            this._sendRequest(e, 0, !1, !0)
        }
        ,
        e.prototype._sendRequest = function(e, t, n, o) {
            var s = this;
            void 0 === o && (o = !1);
            try {
                if (this._paused)
                ...
                var a = 0
                  , u = "";
                for (var d in e)
                    e.hasOwnProperty(d) && (this._killSwitch.isTenantKilled(d) ? (l.default.eventsRejected(e[d], i.AWTEventsRejectedReason.KillSwitch),
                    delete e[d]) : (u.length > 0 && (u += ","),
                    u += d,
                    a++));
                if (a > 0) {
                    var p = r.default.getPayloadBlob(e, a);
                    p.remainingRequest && this._requestQueue.push(p.remainingRequest);
                    var f = this._urlString + "&x-apikey=" + u + "&client-time-epoch-millis=" + Date.now().toString();
                    this._clockSkewManager.shouldAddClockSkewHeaders() && (f = f + "&time-delta-to-apply-millis=" + this._clockSkewManager.getClockSkewHeaderValue());
                    var _ = void 0;
                    for (var d in _ = c.isUint8ArrayAvailable() ? new Uint8Array(p.payloadBlob) : r.default.base64Encode(p.payloadBlob),
                    e)
                        if (e.hasOwnProperty(d))
                            for (var h = 0; h < e[d].length; ++h)
                                e[d][h].sendAttempt > 0 ? e[d][h].sendAttempt++ : e[d][h].sendAttempt = 1;
                    if (this._useBeacons && n && c.isBeaconsSupported() && navigator.sendBeacon(f, _))
                        return;
                    this._httpInterface.sendPOST(f, _, (function(i, r) {
                        s._retryRequestIfNeeded(i, r, e, a, u, t, n, o)
                    }
                    ), (function(i, r) {
                        s._retryRequestIfNeeded(i, r, e, a, u, t, n, o)
                    }
                    ...
                    n || this._handleRequestFinished(!1, {}, n, o)
            } catch (e) {
                this._handleRequestFinished(!1, {}, n, o)
            }
        }
        ,
        e.prototype._retryRequestIfNeeded = function(e, t, n, r, s, a, u, c) {
            var p = this
              , f = !0;
            if (void 0 !== e) {
                if (t) {
                    var _ = this._killSwitch.setKillSwitchTenants(t["kill-tokens"], t["kill-duration-seconds"]);
                    this._clockSkewManager.setClockSkew(t["time-delta-millis"]);
                    for (var h = 0; h < _.length; ++h)
                        l.default.eventsRejected(n[_[h]], i.AWTEventsRejectedReason.KillSwitch),
                        delete n[_[h]],
                        r--
                } else
                    this._clockSkewManager.setClockSkew(null);
                if (200 === e)
                    return void this._handleRequestFinished(!0, n, u, c);
                (!o.default.shouldRetryForStatus(e) || r <= 0) && (f = !1)
            }
            if (f)
                if (c)
                    this._activeConnections--,
                    n[s][0].priority = i.AWTEventPriority.High,
                    this._queueManager.addBackRequest(n);
                else if (a < 1) {
                    for (var v in n)
                        n.hasOwnProperty(v) && l.default.eventsRetrying(n[v]);
                    setTimeout((function() {
                        return p._sendRequest(n, a + 1, !1)
                    }
                    ), o.default.getMillisToBackoffForRetry(a))
                } else
                    this._activeConnections--,
                    d.default.backOffTransmission(),
                    this._queueManager.addBackRequest(n);
            else
                this._handleRequestFinished(!1, n, u, c)
        }
        ,
        e.prototype._handleRequestFinished = function(e, t, n, r) {
            for (var o in e && d.default.clearBackOff(),
            t)
                t.hasOwnProperty(o) && (e ? l.default.eventsSent(t[o]) : l.default.eventsDropped(t[o], i.AWTEventsDroppedReason.NonRetryableStatus));
            this._activeConnections--,
...
, function(e, t, n) {
    ...
    var a = function() {
        ...
        e.prototype._WriteFieldBegin = function(e, t, n) {
            t <= 5 ? this._stream._WriteByte(e | t << 5) : t <= 255 ? (this._stream._WriteByte(192 | e),
...
, function(e, t, n) {
    ...
    t._Utf8_GetBytes = function(e) {
        for (var t = [], n = 0; n < e.length; ++n) {
            ...
            i < 128 ? t.push(i) : i < 2048 ? t.push(192 | i >> 6, 128 | 63 & i) : i < 55296 || i >= 57344 ? t.push(224 | i >> 12, 128 | i >> 6 & 63, 128 | 63 & i) : (i = 65536 + ((1023 & i) << 10 | 1023 & e.charCodeAt(++n)),
    ...
    t._Base64_GetString = function(e) {
        for (var t, n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", i = [], r = e.length % 3, o = 0, s = e.length - r; o < s; o += 3) {
            var a = (e[o] << 16) + (e[o + 1] << 8) + e[o + 2];
            i.push([n.charAt((t = a) >> 18 & 63), n.charAt(t >> 12 & 63), n.charAt(t >> 6 & 63), n.charAt(63 & t)].join(""))
        }
        switch (r) {
        case 1:
            a = e[e.length - 1];
            i.push(n.charAt(a >> 2)),
            i.push(n.charAt(a << 4 & 63)),
            i.push("==");
            break;
        case 2:
            var u = (e[e.length - 2] << 8) + e[e.length - 1];
            i.push(n.charAt(u >> 10)),
            i.push(n.charAt(u >> 4 & 63)),
            i.push(n.charAt(u << 2 & 63)),
            i.push("=")
        }
        return i.join("")
    }
    ...
    var i = function() {
        ...
        return e._ConvertNumberToArray = function(e, t) {
            ...
            var n = t ? 52 : 23
              ...
              , s = e < 0 ? 1 : 0;
            e = Math.abs(e);
            for (var a = Math.floor(e), u = e - a, c = 2 * (i + 2) + n, l = new Array(c), d = 0; d < c; )
                l[d++] = 0;
            for (d = i + 2; d && a; )
                l[--d] = a % 2,
                a = Math.floor(a / 2);
            ...
            var f = i + 1 - p
              , _ = p + n;
            if (l[_ + 1]) {
                for (d = _; d > p && (l[d] = 1 - l[d],
                !l); --d)
                    ;
                d === p && ++f
            }
            if (f > o || a)
                return s ? t ? this._doubleNegInifinity : this._floatNegInifinity : t ? this._doubleInifinity : this._floatInifinity;
            if (f < r)
                return t ? this._doubleZero : this._floatZero;
            if (t) {
                var h = 0;
                ...
                for (var v = 0; d < 52; ++d)
                    v = v << 1 | l[++p];
                return [255 & v, v >> 8 & 255, v >> 16 & 255, v >>> 24, 255 & (h = s << 31 | 2147483647 & (h |= f + i << 20)), h >> 8 & 255, h >> 16 & 255, h >>> 24]
            }
            var y = 0;
            for (d = 0; d < 23; ++d)
                y = y << 1 | l[++p];
            return [255 & (y = s << 31 | 2147483647 & (y |= f + i << 23)), y >> 8 & 255, y >> 16 & 255, y >>> 24]
        }
        ,
            ...
            if (e && t)
                try {
                    ...
                    if ("this-request-only" === t)
                        return n;
                    for (var i = 1e3 * parseInt(t, 10), r = 0; r < n.length; ++r)
                        this._killedTokenDictionary[n[r]] = Date.now() + i
                } catch (e) {
                    return []
                }
            return []
...
, function(e, t, n) {
    "use strict";
    n.r(t),
    n.d(t, "AgaveSink", (function() {
        return J
    }
    )),
    n.d(t, "TelemetryContext", (function() {
        return h
    }
    ));
    var i, r, o, s, a, u, c, l, d, p = new (function() {
        function e() {
            this._listeners = []
        }
    ...
    var h = function() {
        function e() {}
        return e.setTelemetryContext = function(e) {
            this._steContext = e
        }
        ,
        e.getDataFieldsFromContext = function() {
            var e = this
              , t = [];
            return Object.keys(this._steContext).forEach((function(n) {
                t.push({
                    name: n,
                    value: e._steContext[n],
                    dataType: d.String
                })
            }
            )),
        ...
        ,
        e.getAppName = function() {
            return this._steContext["App.Name"]
        }
        ,
        e.getAppPlatform = function() {
      ...
      , v = function() {
        function e() {
            this._requestIsPending = !1,
            this._telemetryQueue = [],
            this._sentFirstEvent = !1
        }
        return e.prototype.isSupportedByDeclaration = function() {
            return Office.context.requirements.isSetSupported("Telemetry", "1.2")
        }
        ,
        e.prototype.isUnsupported = function() {
            return h.isWacAgave() || "undefined" == typeof OfficeCore
        }
        ,
        e.prototype.isSupportedAsync = function(e) {
            (this._sentFirstEvent || void 0 !== this._onSentFirstEvent) && (f(i.Error, r.Sink, (function() {
                return "isSupportedAsync may only be called once"
            }
            )),
            e(!1)),
            this._onSentFirstEvent = e,
            this.sendTestEvent()
        }
        ,
        e.prototype.sendTelemetryEvent = function(e) {
            this._telemetryQueue.push(e),
            this._requestIsPending || this.processWorkBacklog()
        }
        ,
        e.prototype.sendTestEvent = function() {
            var e = {
                telemetryProperties: {
                ...
                eventFlags: {
                    dataCategories: u.ProductServiceUsage,
                    diagnosticLevel: c.FullEvent
                }
            };
        ...
        e.prototype.processWorkBacklog = function() {
            ...
            var t = this._telemetryQueue;
            this._telemetryQueue = [],
            this.pauseIfNecessary().then((function() {
                e.processTelemetryEvents(t),
                e.waitAndProcessMore()
            }
            )).catch((function(t) {
                _(r.Sink, "RichApiSink Error", t),
                e.waitAndProcessMore()
            }
            ))
        }
        ,
        e.prototype.waitAndProcessMore = function() {
            var e = this;
            y(1e3).then((function() {
                e._telemetryQueue.length > 0 && setTimeout((function() {
                    return e.processWorkBacklog()
                }
                ), 0),
                e._requestIsPending = !1
            }
            )).catch((function() {}
            ))
        }
        ,
        e.prototype.processTelemetryEvents = function(e) {
            var t = this
              , n = new OfficeCore.RequestContext;
            e.forEach((function(e) {
                if (e.telemetryProperties) {
                    var l = [];
                    t.addDataFields(l, e.dataFields);
                    var d = e.eventContract ? e.eventContract.name : "";
                    e.eventContract && t.addDataFields(l, e.eventContract.dataFields),
                    n.telemetry.sendTelemetryEvent(e.telemetryProperties, e.eventName, d, function(e) {
                        var t = {
                            costPriority: a.Normal,
                            samplingPolicy: o.Measure,
                            persistencePriority: s.Normal,
                            dataCategories: u.NotSet,
                            diagnosticLevel: c.FullEvent
                        };
                        return e.eventFlags && e.eventFlags.dataCategories || f(i.Error, r.Core, (function() {
                            return "Event is missing DataCategories event flag"
                        }
                        )),
                        e.eventFlags ? (e.eventFlags.costPriority && (t.costPriority = e.eventFlags.costPriority),
            ...
            this._sentFirstEvent ? n.sync().catch((function(e) {
                _(r.Sink, "RichApiError", e)
            }
            )) : (this._sentFirstEvent = !0,
            n.sync().then((function() {
                t._onSentFirstEvent && t._onSentFirstEvent(!0)
            }
            )).catch((function() {
                f(i.Info, r.Sink, (function() {
                    return "RichApiTelemetry not supported on the host."
                }
                )),
                t._onSentFirstEvent && t._onSentFirstEvent(!1)
            }
            )))
        }
        ,
        e.prototype.addDataFields = function(e, t) {
            t && t.forEach((function(t) {
                e.push({
                    name: t.name,
                    value: t.value,
                    classification: t.classification ? t.classification : l.SystemMetadata,
                    type: t.dataType
                })
            }
            ))
        ...
        ,
        e.prototype.pauseIfNecessary = function() {
            return this._sentFirstEvent ? Office.Promise.resolve(void 0) : y(1e3)
        }
        ,
        e
    }();
    function y(e) {
        return new Office.Promise((function(t) {
    ...
    var g = function() {
        function e() {}
        return e.prototype.sendTelemetryEvent = function(t) {
            e._richApiHelper.sendTelemetryEvent(t)
        }
        ,
        e.isSupportedByDeclaration = function() {
            return this._richApiHelper.isSupportedByDeclaration()
        }
        ,
        e.isUnsupported = function() {
            return this._richApiHelper.isUnsupported()
        }
        ,
        e.isSupportedAsync = function(e) {
            return this._richApiHelper.isSupportedAsync(e)
        }
        ,
        e._richApiHelper = new v,
        e
    }();
    var T = function() {
        function e() {}
        ...
        ,
        e.prototype.sendTelemetryEvent = function(e, t) {
            try {
                if (e.dataFields && e.dataFields.filter((function(e) {
                    return e.classification && e.classification !== l.SystemMetadata
                }
                )).length > 0)
                    return;
                var n = OSF._OfficeAppFactory.getId()
                  , i = OSF.AgaveHostAction.SendTelemetryEvent;
                OSF.getClientEndPoint().invoke("ContextActivationManager_notifyHost", null, [n, i, e])
            } catch (e) {
                _(r.Sink, "AgaveWacSink", e)
            }
        }
        ,
        e
      ...
      , m = function() {
        function e() {
            this._supportsAllEvents = !1,
            this._contextDataFields = [],
            this._supportsAllEvents = Office.context.requirements.isSetSupported("OutlookTelemetry", "1.1");
            var e = h.getAppPlatform();
            "iOS" !== e && "Android" !== e || (this._contextDataFields = h.getDataFieldsFromContext())
        }
        return e.isSupported = function() {
            try {
        ...
        ,
        e.prototype.sendTelemetryEvent = function(e) {
            this._supportsAllEvents || e.eventName.match(/^Office\.Extensibility\.OfficeJs\.[a-zA-Z]*$/) ? (this.addAdditionalDataFields(e),
            Office.context.mailbox.logTelemetry(JSON.stringify(e))) : f(i.Info, r.Sink, (function() {
                return "This version of Outlook only accepts OfficeJS telemetry events"
            }
            ))
        }
        ,
        e.prototype.addAdditionalDataFields = function(e) {
            var t;
            e.dataFields = e.dataFields || [],
            (t = e.dataFields).push.apply(t, this._contextDataFields)
        }
        ,
        e
    }()
      ...
      , P = [2, 29]
      , I = [16, 0, 99999]
      , W = ["Excel", "Outlook", "PowerPoint", "Project", "Word"]
      , b = !1;
    function w() {
        if (!b)
            return !1;
        ...
        return function(e, t, n) {
            ...
            var o = String(e).split(".").map((function(e) {
                return parseInt(e, 10)
            }
            ));
            return C(r, o) && C(o, i)
        }(h.getAppVersion(), e, h.getAppName())
    }
    function C(e, t) {
        for (var n = 0; n < e.length && n < t.length; n++) {
            if (isNaN(e[n]) || isNaN(t[n]))
                return !1;
            if (e[n] < t[n])
                return !0;
            if (e[n] > t[n])
    ...
    function R(e, t, n) {
        t && t.forEach((function(t) {
            if (!t.classification || t.classification === l.SystemMetadata || t.classification === l.EssentialServiceMetadata) {
                var i = ["", "", t.name]
                  , r = i[0]
                  , o = i[1]
                  , s = i[2]
                  , a = t.name.indexOf(".");
                a > 0 && "zC" === t.name.substr(0, a) && (r = t.name.substring(0, a + 1),
                s = t.name.substring(a + 1)),
                n && (o = "Data.");
                var u = r + o + s;
                e.properties[u] = {
                    value: t.value,
    ...
    function N(e) {
        ...
        case d.Int64:
            return O.AWTPropertyType.Int64;
        case d.Double:
    ...
    var M, x, U, F, L = n(4), q = n.n(L), z = n(11), H = n.n(z);
    var j = {
        sendRequestWrapper: function(e, t, n, i) {
            void 0 === i && (i = !1);
            var r = 0;
            for (var o in e)
                e.hasOwnProperty(o) && (r += e[o].length);
            var s = performance.now();
            M(e, t, n, i),
            U(performance.now() - s, r)
        },
        sendPostWrapper: function(e, t, n, i, r, o) {
            x(e, t, n, i, r, o),
            F(t.length)
        }
    };
    ...
    function V(e, t, n) {
        var i;
        if (G(),
        !e.telemetryProperties || !e.telemetryProperties.ariaTenantToken)
            throw new Error("Missing Aria Tenant Token");
        i = function(e, t, n) {
            var i, r, o = {
                name: (i = e.eventName,
                i.toLowerCase().replace(k, "_")),
                properties: {}
            };
            return o.properties["Event.Sequence"] = {
                value: ++D,
                type: O.AWTPropertyType.Int64
            },
            o.properties["Event.Name"] = e.eventName,
            o.properties["Event.Source"] = "OTelJS",
            r = n ? new Date(n) : new Date,
            o.properties["Event.Time"] = {
                value: r,
                type: O.AWTPropertyType.Date
            },
            e.eventContract && (o.properties["Event.Contract"] = e.eventContract.name,
            R(o, e.eventContract.dataFields, !1)),
            R(o, t, !1),
            R(o, e.dataFields, !0),
            o
        }(e, t, n),
        B.AWTLogManager.getLogger(e.telemetryProperties.ariaTenantToken).logEvent(i)
    }
    function G(e, t) {
        var n;
        Q || (B.AWTLogManager.initialize("cd836626611c4caaa8fc5b2e728ee81d-3b6d6c45-6377-4bf5-9792-dbf8e1881088-7521", e),
        t && (!function(e) {
            if (!e)
                return;
            var t = e / 1e3
              ...
              , i = 2 * t
              , r = {};
            r.OTelCustomTransmissionProfile = [i, t, n],
            B.AWTLogManager.loadTransmitProfiles(r),
            B.AWTLogManager.setTransmitProfile("OTelCustomTransmissionProfile")
        }(t.uploadFrequency),
        (n = t.notificationListener) && B.AWTLogManager.addNotificationListener(n),
        function(e) {
            if (!e)
                return;
            (function(e, t) {
                var n = q.a.getEventsHandler();
                if (!(n instanceof H.a))
                    return !1;
                var i = n._httpManager;
                if (!(i && i._sendRequest && i._httpInterface))
                    return !1;
                M = i._sendRequest.bind(i),
                i._sendRequest = j.sendRequestWrapper;
                var r = i._httpInterface;
                return x = r.sendPOST.bind(i),
                r.sendPOST = j.sendPostWrapper,
                U = e,
                F = t,
                !0
            }
            )(e.requestProcessingStats, e.networkStats) || f(i.Error, r.Sink, (function() {
                return "Failed to instrument Aria delivery task"
            }
            ))
        }(t.stats),
        t.disableStatsTracking || B.AWTLogManager.addNotificationListener({
            eventsSent: function(e) {
                f(i.Info, r.Transport, (function() {
                    return "Successfully sent " + e.length + " event(s)"
                }
                )),
                f(i.Verbose, r.Transport, (function() {
                    return "Sent event(s) details : " + JSON.stringify(e, null, 2)
                }
                )),
                e.length
            },
            eventsDropped: function(e, t) {
                f(i.Error, r.Transport, (function() {
                    return "Dropped " + e.length + " event(s) because " + t
                }
                )),
                f(i.Verbose, r.Transport, (function() {
                    return "Dropped event(s) details : " + JSON.stringify(e, null, 2)
                }
                )),
                e.length
            },
            eventsRejected: function(e, t) {
                f(i.Error, r.Transport, (function() {
                    return "Rejected " + e.length + " event(s) because " + t
                }
                )),
                f(i.Verbose, r.Transport, (function() {
                    return "Rejected event(s) details : " + JSON.stringify(e, null, 2)
                }
                )),
                e.length
            },
            eventsRetrying: function(e) {
                f(i.Warning, r.Transport, (function() {
                    return "Retrying " + e.length + " event(s)"
                }
                )),
                f(i.Verbose, r.Transport, (function() {
                    return "Retrying event(s) details : " + JSON.stringify(e, null, 2)
                }
                )),
                e.length
            }
    ...
    var K, Z = function() {
        ...
        return e.prototype.processEvent = function(e) {
            return this._fullEventsEnabled || !!e.eventFlags && (e.eventFlags.diagnosticLevel === c.BasicEvent || e.eventFlags.diagnosticLevel === c.NecessaryServiceDataEvent || e.eventFlags.diagnosticLevel === c.AlwaysOnNecessaryServiceDataEvent)
        }
        ,
        e.prototype.setFullEventsEnabled = function(e) {
            this._fullEventsEnabled = e
        }
        ,
        e
    }();
    ...
    var X = function() {
        function e(t, n) {
            if (void 0 === t && (t = []),
            this._preprocessors = [],
            this.additionalDataFields = t,
            this._fullEventProcessor = new Z,
            this.addPreprocessor(this._fullEventProcessor),
            void 0 === e.ariaSinkType)
                e.ariaSinkType = this.getSinkType();
            else if (e.ariaSinkType !== this.getSinkType())
                throw new Error("Multiple Aria Configurations are not allowed");
            G(this.getAWTLogConfiguration(n), n)
        }
        return e.prototype.getSinkType = function() {
            return K.Aria
        }
        ,
        e.prototype.getAWTLogConfiguration = function(e) {
            var t = {
            ...
            return e && (t.cacheMemorySizeLimitInNumberOfEvents = e.eventsLimitInMem,
            t.collectorUri = e.endpointUrl),
            t
        }
        ,
        e.prototype.sendTelemetryEvent = function(e, t) {
            try {
                for (var n = 0; n < this._preprocessors.length; n++)
                    if (!this._preprocessors[n].processEvent(e))
                        return;
                V(e, this.additionalDataFields, t)
            } catch (e) {
                _(r.Sink, "AriaSink", e)
            }
        }
        ,
        e.prototype.getAdditionalDataFields = function() {
            return this.additionalDataFields
        }
        ,
        e.prototype.addPreprocessor = function(e) {
            this._preprocessors.push(e)
        }
        ,
        e.prototype.setFullEventsEnabled = function(e) {
            this._fullEventProcessor.setFullEventsEnabled(e)
        }
        ,
        e.prototype.flushAsync = function(e) {
            B.AWTLogManager.flush(e)
        }
        ,
        e.prototype.shutdown = function() {
            B.AWTLogManager.flushAndTeardown()
        }
        ,
        e
    }();
    var J = function() {
        function e(e, t, n) {
            this._isUsable = !0,
            this._awaitingInitialization = !1,
            this._eventQueue = [],
            this._onReady = n,
            h.setTelemetryContext(e),
            b = t,
            this.initialize()
        }
        return e.createInstance = function(t, n) {
            void 0 === t && (t = {}),
            void 0 === n && (n = !0);
            var i = new e(t,n);
            if (i._isUsable)
        ...
        e.prototype.initialize = function() {
            if (!this.isTelemetryEnabled())
                return this.failToInitialize("AppTelemetry is disabled for this platform.");
            if (g.isSupportedByDeclaration())
                this.connectRichApiSink();
            else if (m.isSupported())
                this.connectSink("OutlookSink", new m);
            else if (h.isWacAgave() && T.isSupported())
                this.connectSink("SdxWacSink", new T);
            else if (g.isUnsupported()) {
                if (!w())
                    return this.failToInitialize();
                this.connectAriaSink()
            } else
                this._awaitingInitialization = !0,
                g.isSupportedAsync(this.onRichApiSupportedAsync.bind(this))
        }
        ,
        e.prototype.onRichApiSupportedAsync = function(e) {
            var t = this;
            e ? this.connectSink("RichApiSink", new g) : w() ? this.connectAriaSink() : this.failToInitialize(),
            this._awaitingInitialization = !1,
            this._eventQueue.forEach((function(e) {
                t.sendTelemetryEvent(e)
            }
            ))
        }
        ,
        e.prototype.failToInitialize = function(e) {
            this._isUsable = !1,
            this._awaitingInitialization = !1;
            var t = e || "AgaveSink has no available sink";
            f(i.Error, r.Sink, (function() {
                return t
            }
            )),
        ...
        e.prototype.sendTelemetryEvent = function(e) {
            if (this._awaitingInitialization && this._isUsable)
                ...
                try {
                    this._sink.sendTelemetryEvent(e)
                } catch (e) {
                    _(r.Sink, "AgaveSink", e)
                }
            else
                f(i.Error, r.Sink, (function() {
        ...
        ,
        e.prototype.connectSink = function(e, t) {
            this._sink = t,
            f(i.Info, r.Sink, (function() {
                return "AgaveSink is using " + e
            }
            )),
            this._onReady && this._onReady(!0)
        }
        ,
        e.prototype.connectRichApiSink = function() {
            this.connectSink("RichApiSink", new g)
        }
        ,
        e.prototype.connectAriaSink = function() {
            var e, t = this;
            e = h.getDataFieldsFromContext(),
            function(e) {
                e ? t.connectSink("AriaSink", e) : t.failToInitialize()
            }(new X(e))
        }
        ,
        e.prototype.isTelemetryEnabled = function() {
            return !("undefined" == typeof OSF || void 0 === OSF.AppTelemetry || "boolean" != typeof OSF.AppTelemetry.enableTelemetry || !OSF.AppTelemetry.enableTelemetry) || (f(i.Warning, r.Core, (function() {
