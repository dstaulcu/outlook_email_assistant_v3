if (window.Type && window.Type.registerNamespace) {
    ...
    if (typeof (window['"_u"']) == 'undefined') {
        window['"_u"'] = new Object();
        window['"_u"'].__namespace = true;
    }

}
_u.ExtensibilityStrings = function() {}
;
if (_u.ExtensibilityStrings.registerClass)
...
_u.ExtensibilityStrings.l_InvalidOpenLocationInput_Text = "OpenLocation is invalid.";
_u.ExtensibilityStrings.l_InvalidParameterValueError_Text = "The value of the '{0}' parameter is invalid.";
_u.ExtensibilityStrings.l_InvalidSaveLocationInput_Text = "SaveLocation is invalid.";
...
_u.ExtensibilityStrings.l_MAMServiceNotAvailable_Text = "Failed to retrieve MAM Policy.";
